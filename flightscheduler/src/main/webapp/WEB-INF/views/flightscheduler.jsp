	...
	<div class="starter-template">
		...
		<form class="form-horizontal" id="flight-scheduler-form" name="flight-scheduler-name">
			...
			<div class="form-group form-group-lg">
				...
				<span id="originSpanID" class="col-sm-offset-2 col-sm-6" style="display:none;"></span>
			</div>
			...
			<div class="form-group form-group-lg">
				...
				<span id="destSpanID" class="col-sm-offset-2 col-sm-6" style="display:none;"></span>
			</div>
			...
			<div class="form-group form-group-lg">
				<label class="col-sm-2 control-label">Air Carrier codes</label>
				<div class="col-sm-3">
